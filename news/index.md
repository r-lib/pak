...
- pak can now consider installed packages in mutliple libraries, when
  installing packages. Pass a character vector of library path as the
  `lib` argument of
...
- New function
  [`scan_deps()`](https://pak.r-lib.org/reference/scan_deps.md) to
...
- [`pkg_deps()`](https://pak.r-lib.org/reference/pkg_deps.md) now
...
- [`repo_add()`](https://pak.r-lib.org/reference/repo_add.md) and the
  `ppm_*()` functions,
  e.g. [`ppm_snapshots()`](https://pak.r-lib.org/reference/ppm_snapshots.md),
...
- In [`repo_add()`](https://pak.r-lib.org/reference/repo_add.md) and
  [`repo_resolve()`](https://pak.r-lib.org/reference/repo_add.md) the
  `MRAN@` prefix is now deprecated and resolves to PPM, because MRAN
...
- pak functions that used to return tibbles return data frames now.
  ...
  Relatedly,
  [`pak::pak_install_extra()`](https://pak.r-lib.org/reference/pak_install_extra.md)
