...
```
    ...
    #> ✔ 1 pkg + 9 deps: added 10, dld 10 (4.22 MB) [54.8s]
...
```
    ...
    #> ✔ Packaged tibble 3.3.1.9008 (821ms)
...
```
    ...
    #> ✔ 1 pkg: upd 1, dld 1 (640.24 kB) [12.3s]
