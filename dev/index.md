...
```
    ...
    #>
    #> → Package library at /tmp/RtmpR755RY/file2d162b35a1bf.
    ...
    #> ✔ Installed lifecycle 1.0.5  (20ms)
    #> ℹ Building vctrs 0.7.3
    #> ✔ Built vctrs 0.7.3 (23.2s)
    ...
    #> ✔ 1 pkg + 9 deps: added 10, dld 10 (4.24 MB) [52.5s]
...
```
    ...
    #> ✔ 1 pkg: upd 1, dld 1 (644.13 kB) [11.5s]
