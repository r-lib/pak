...
```
    ...
    #> ✔ Built rlang 1.1.6 (13.1s)
    #> ✔ Installed rlang 1.1.6  (57ms)
    ...
    #> ✔ 1 pkg + 9 deps: added 10, dld 10 (4.14 MB) [48.8s]
...
```
    ...
    #> ✔ Packaged tibble 3.3.0.9013 (783ms)
...
```
    ...
    #> ✔ 1 pkg: upd 1, dld 1 (640.24 kB) [11s]
