...
```
    ...
    #> ✔ 1 pkg + 9 deps: added 10, dld 10 (4.14 MB) [50.5s]
...
```
    ...
    #> ✔ Packaged tibble 3.3.0.9013 (808ms)
    #> ℹ Building tibble 3.3.0.9013
    #> ✔ Built tibble 3.3.0.9013 (2.8s)
...
```
    ...
    #> ✔ Installed cli 3.6.5 (local) (34ms)
    #> ✔ 1 pkg: upd 1, dld 1 (640.24 kB) [10.8s]
