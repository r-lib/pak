...
```
    ...
    #> → Will download 5 CRAN packages (1.32 MB), cached: 5 (2.90 MB).
    #> + cli         3.6.6  [bld][cmp]
    #> + glue        1.8.1  [bld][cmp]
    #> + lifecycle   1.0.5  [bld][dl] (107.14 kB)
    #> + magrittr    2.0.5  [bld][cmp]
...
```
    ...
    #> ✔ Packaged tibble 3.3.1.9010 (804ms)
    #> ℹ Building tibble 3.3.1.9010
    #> ✔ Built tibble 3.3.1.9010 (2.8s)
    #> ✔ Installed tibble 3.3.1.9010 (github::tidyverse/tibble@0bbde5d) (26ms)
