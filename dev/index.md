...
```
    ...
    #>
    #> → Package library at /tmp/RtmpLl9BeM/file2d27600ea73.
    ...
    #> ✔ Built cli 3.6.6 (12.5s)
    #> ✔ Installed cli 3.6.6  (32ms)
    #> ✔ Built rlang 1.2.0 (12.8s)
    ...
    #> ✔ 1 pkg + 9 deps: added 10, dld 10 (4.24 MB) [55.2s]
...
```
    ...
    #> ✔ 1 pkg + 9 deps: kept 9, upd 1, dld 1 (NA B) [7s]
...
```
    ...
    #> ℹ Building cli 3.6.6
    #> ✔ Built cli 3.6.6 (9.3s)
    #> ✔ Installed cli 3.6.6 (local) (62ms)
