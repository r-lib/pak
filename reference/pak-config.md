...
- ‘cran_mirror’: (Env var: `PKG_CRAN_MIRROR`, option:
  ...
  [`pak::repo_add()`](https://pak.r-lib.org/reference/repo_add.md) and
  [`pak::repo_get()`](https://pak.r-lib.org/reference/repo_get.md)
...
- ‘package_cache_dir’: (Env var: `PKG_PACKAGE_CACHE_DIR`, option:
  ...
  See
  [`pak::cache_summary()`](https://pak.r-lib.org/reference/cache.md).
