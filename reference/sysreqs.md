...
Call
[`pak::sysreqs_platforms()`](https://pak.r-lib.org/reference/sysreqs_platforms.md)
...
Call
[`pak::sysreqs_is_supported()`](https://pak.r-lib.org/reference/sysreqs_is_supported.md)
...
[`pkg_deps()`](https://pak.r-lib.org/reference/pkg_deps.md) but in
...
See the manual of
[`pkg_sysreqs()`](https://pak.r-lib.org/reference/pkg_sysreqs.md) to see
how to programmatically extract information from its return value.
