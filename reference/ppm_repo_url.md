...
To use [`repo_add()`](https://pak.r-lib.org/reference/repo_add.md) with
PPM snapshots, you may also set the `PKGCACHE_PPM_REPO` environment
...
[`repo_resolve()`](https://pak.r-lib.org/reference/repo_add.md) and
[`repo_add()`](https://pak.r-lib.org/reference/repo_add.md) to find and
configure PPM snapshots.
