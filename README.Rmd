...
Start with our [our TLDR document](https://pak.r-lib.org/dev/articles/tldr.html) to solve specific issues.

### FAQ

Check out [list of frequently asked questions](https://pak.r-lib.org/dev/articles/faq.html).
...
See the [complete list of awesome features](https://pak.r-lib.org/dev/articles/features.html).
...
See the [installation page](https://pak.r-lib.org/dev/articles/install.html)!
